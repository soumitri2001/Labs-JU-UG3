...
public class BestFirstSearch_Ass4_SoumitriChattopadhyay {
    ...
    public static int getManhattan(int A[][], int B[][]) {
    ...
    public static void main(String[] args) {
        ...
        int curr_distance = getManhattan(startState, goalState);
        ...
        int temp_distance, min_distance, currX = -1, currY = -1;
        ...
        while (curr_distance != 0) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (tempX >= 0 && tempX < 3 && tempY >= 0 && tempY < 3) {
                    ...
                    temp_distance = getManhattan(temp, goalState);
        ...
        System.out.println("\nThe Path length from starting state to goal state using BestFS is: " + value + "\n");
    }
}
